...
OUTPUT = r"C:\AM_TribonBridge\diagnostics\demo-highlight-all-flanges-result.tsv"

EXPECTED_OBJECT_COUNT = 7
EXPECTED_HANDLE_COUNT = 71
...
def load_target_objects():
    ...
    for chunk in chunks[1:]:
        ...
        if category not in ("PIPE_FLANGE_FRONT", "PIPE_FLANGE_SIDE", "STRUCTURAL_FLANGE"):
            continue
...
def main():
    lines = [
        "FORMAT\tAM_DEMO_HIGHLIGHT_ALL_FLANGES_V1",
        "SNAPSHOT\t" + SNAPSHOT
    ]
    ...
    lines.append("TARGET_CATEGORY\tPIPE_FLANGE_FRONT")
    lines.append("TARGET_CATEGORY\tPIPE_FLANGE_SIDE")
    lines.append("TARGET_CATEGORY\tSTRUCTURAL_FLANGE")
